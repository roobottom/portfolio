...
{{ figure({src: 'big-red-button.jpg', caption: 'Robin, Viv and I gather around the beautifully designed button to activate Firefly 6 in our offices in Hammersmith, 12th December 2016',class: 'side-by-side'}) }}
...
{{ figure({src: 'team-firefly.jpg', caption: 'Almost all of Team Firefly at the Firefly Learning Conference in Birmingham, 15th November 2016',class: 'max'}) }}
